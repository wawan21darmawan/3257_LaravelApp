...
<body class="bg-slate-50 text-slate-900">
    ...
    <nav
        ...
        <!-- Kiri: Logo & Menu Navigasi Dikelompokkan Bersama -->
        ...
        <!-- Kanan: Tombol Masuk / Dashboard dengan Background Biru -->
        <div class="flex items-center">
                <a href="{{ route('login') }}" class="px-5 py-2.5 bg-indigo-600 text-white rounded-xl font-semibold shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition">
                    Masuk
                </a>
        </div>
    </nav>
