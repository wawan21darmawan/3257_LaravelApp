    ...
    <div class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm max-w-3xl">
        ...
        <form action="{{ route('organizer.events.update', $event->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <select name="category_id" class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl"
                    required>
            ...
            <div>
                ...
                <input type="file" name="poster" accept="image/*" class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl 
