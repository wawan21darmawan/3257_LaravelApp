...
<body class="bg-indigo-900 text-white min-h-screen flex items-center justify-center p-6">
    <div class="max-w-md w-full bg-white text-slate-900 rounded-[2rem] p-8 shadow-2xl">
        ...
        <div class="mt-8 flex items-center justify-center space-x-4">
            ...
            <span class="text-xs font-bold text-slate-400 uppercase tracking-widest whitespace-nowrap">Atau masuk dengan</span>
            <span class="h-px w-full bg-slate-200"></span>
        </div>

        <!-- Tombol Google SSO -->
        <div class="mt-6">
            <a href="{{ route('google.login') }}" class="w-full flex items-center justify-center px-5 py-4 border-2 border-slate-200 rounded-2xl shadow-sm text-lg font-bold text-slate-700 bg-white hover:bg-slate-50 hover:border-slate-300 transition">
